...
export class TherapistsPatientsFacade extends EntityFacade<TherapistPatient> {
     ...
     */
    public insertTherapistPatient(therapistPatient: TherapistPatient): Promise<TherapistPatient> {
        const attributes: SQLValueAttributes = this.getSQLValueAttributes(this.tableName, therapistPatient);
     ...
     */
    protected getSQLValueAttributes(prefix: string, therapistPatient: TherapistPatient): SQLValueAttributes {
        const attributes: SQLValueAttributes = new SQLValueAttributes();

        const therapistIdAttribute: SQLValueAttribute = new SQLValueAttribute("therapist_id", prefix, therapistPatient.therapistId);
        attributes.addAttribute(therapistIdAttribute);

        const patientIdAttribute: SQLValueAttribute = new SQLValueAttribute("patient_id", prefix, therapistPatient.patientId);
